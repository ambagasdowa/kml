<?php ?>	
	...
	<tr<?php echo $class;?>>
        ...
        <td><?php echo $projectionsViewIndicatorsPeriod['ProjectionsViewIndicatorsPeriod']['subsubtotal']; ?>&nbsp;</td>
        <td><?php echo $projectionsViewIndicatorsPeriod['ProjectionsViewIndicatorsPeriod']['subpeso']; ?>&nbsp;</td>
