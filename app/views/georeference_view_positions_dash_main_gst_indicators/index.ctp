<?php 
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Georeference View Positions Dash Main Gst Indicator', true), array('action' => 'add')); ?>			</li>
							<li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Georeference View Positions Dash Main Gst Indicators');?></h1>
			...
			<span class="filter-container">
				...
				<thead>
					<tr>
													...
													<th><?php echo $this->Paginator->sort('despacho');?></th>
				...
				<?php
				$i = 0;
				foreach ($georeferenceViewPositionsDashMainGstIndicators as $georeferenceViewPositionsDashMainGstIndicator):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $georeferenceViewPositionsDashMainGstIndicator['GeoreferenceViewPositionsDashMainGstIndicator']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $georeferenceViewPositionsDashMainGstIndicator['GeoreferenceViewPositionsDashMainGstIndicator']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $georeferenceViewPositionsDashMainGstIndicator['GeoreferenceViewPositionsDashMainGstIndicator']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $georeferenceViewPositionsDashMainGstIndicator['GeoreferenceViewPositionsDashMainGstIndicator']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
