	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $secureTopic['SecureTopic']['id']), array('data-edit'=>'linkSecureTopics_'.$secureTopic['SecureTopic']['id'])); ?>
		</td>
		<td class="actions">
...
<?php endforeach; ?>
	...
	?>				</ul>
					<span class="pull-right">
						<?php echo $this->Html->link(__('New Secure Topic', true), array('action' => null),array('class'=>'btn btn-success','id'=>'newSecureTopics','data-name'=>'SecureTopics','role'=>'button','div'=>null)); ?>
					</span>
          </div>
