<?php
		...
		*/
		...
		<!-- <?php debug($chart); ?> -->
		<!-- <?php debug($chart_index); ?> -->
		<!-- work with this -->
		<!-- <?php debug($mod_index); ?>    -->
		<!-- <?php debug($ui_bsu_index); ?> -->
		<!-- <?php debug($ui_mod_index); ?> -->
                                ...
                                <div id="start_tabs_nav">
  								...
  								<div class="panel-body">
                                    ...
                                    <div class="tab-content">
                                        <?php foreach ($mod_index as $mod_inx => $mod_name) { //NOTE fetch the name of the module tons, kms etc ?>
