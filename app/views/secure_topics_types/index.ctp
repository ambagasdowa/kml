...
<!--			<li>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $secureTopicsType['SecureTopicsType']['id']),array('data-edit'=>'linkSecureTopicsTypes_'.$secureTopicsType['SecureTopicsType']['id'])); ?>
		</td>
		<td class="actions">
...
<?php endforeach; ?>
	...
	?>				</ul>
					<span class="pull-right">
						<?php echo $this->Html->link(__('New Secure Topics Type', true), array('action' => 'add'),array('class'=>'btn btn-success','id'=>'newSecureTopicsTypes')); ?>
					</span>
          </div>
