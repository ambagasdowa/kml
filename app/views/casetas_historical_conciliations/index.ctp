    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Casetas Historical Conciliation', true), array('action' => 'add')); ?>			</li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Casetas Historical Conciliations');?></h1>
          <div class="table-responsive">
			<span class="filter-container">
				...
				<?php
				$i = 0;
				foreach ($casetasHistoricalConciliations as $casetasHistoricalConciliation):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
				?>
	<tr<?php echo $class;?>>
		<td><?php echo $casetasHistoricalConciliation['CasetasHistoricalConciliation']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasHistoricalConciliation['CasetasHistoricalConciliation']['monto_conciliado']; ?>&nbsp;</td>
		<td><?php echo $casetasHistoricalConciliation['CasetasHistoricalConciliation']['cruces_conciliados']; ?>&nbsp;</td>
		<td><?php echo $casetasHistoricalConciliation['CasetasHistoricalConciliation']['created']; ?>&nbsp;</td>
		<td><?php echo $casetasHistoricalConciliation['CasetasHistoricalConciliation']['modified']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasHistoricalConciliation['CasetasHistoricalConciliation']['_status']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $casetasHistoricalConciliation['CasetasHistoricalConciliation']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $casetasHistoricalConciliation['CasetasHistoricalConciliation']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $casetasHistoricalConciliation['CasetasHistoricalConciliation']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $casetasHistoricalConciliation['CasetasHistoricalConciliation']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
