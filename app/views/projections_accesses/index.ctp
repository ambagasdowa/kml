<?php 
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($projectionsControlsUsers[$projectionsAccess['ProjectionsControlsUsers']['id']], array('controller' => 'projections_controls_users', 'action' => 'view', $projectionsAccess['ProjectionsControlsUsers']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectionsAccessModules[$projectionsAccess['ProjectionsAccessModules']['id']], array('controller' => 'projections_access_modules', 'action' => 'view', $projectionsAccess['ProjectionsAccessModules']['id'])); ?>
		</td>
		<td>
