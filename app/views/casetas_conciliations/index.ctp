    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Casetas Conciliation', true), array('action' => 'add')); ?>			</li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Casetas Conciliations');?></h1>
          <div class="table-responsive">
			<span class="filter-container">
				...
				<?php
				$i = 0;
				foreach ($casetasConciliations as $casetasConciliation):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
				?>
	<tr<?php echo $class;?>>
		<td><?php echo $casetasConciliation['CasetasConciliation']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasConciliation['CasetasConciliation']['_status']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $casetasConciliation['CasetasConciliation']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $casetasConciliation['CasetasConciliation']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $casetasConciliation['CasetasConciliation']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $casetasConciliation['CasetasConciliation']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
