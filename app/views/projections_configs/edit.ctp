...
?>
      ...
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectionsConfig.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectionsConfig.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Projections Configs', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
		...
		<li><?php echo $this->Html->link(__('List Projections Type Configs', true), array('controller' => 'projections_type_configs', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?> </li>
		<li><?php echo $this->Html->link(__('New Projections Type Configs', true), array('controller' => 'projections_type_configs', 'action' => 'add'),array('class'=>'btn btn-default list-group-item')); ?> </li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Projections Config'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('ProjectionsConfig',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="projectionsConfigs form">
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
		...
		echo $this->Form->input('projections_type_configs_id',array('placeholder'=>'projections_type_configs_id','class'=>'input'));
		echo $this->Form->input('module_data_definition',array('placeholder'=>'module_data_definition','class'=>'input'));
