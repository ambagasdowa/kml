...
<!-- <center> -->
      ...
      <div class="col-md-offset-1 col-sm-11 col-md-11">
		<ul class="list-group list-inline">
			...
			<li>
				<?php echo $this->Html->link(__('List Secure Control Users', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>
			</li>
			<li>
				<?php echo $this->Html->link(__('List Secure Structures', true), array('controller' => 'secure_structures', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?>
			</li>
			<li>
				<?php echo $this->Html->link(__('New Secure Structures', true), array('controller' => 'secure_structures', 'action' => 'add'),array('class'=>'btn btn-default list-group-item')); ?>
			</li>
			<li>
				<?php echo $this->Html->link(__('List View Get Payrolls', true), array('controller' => 'view_get_payrolls', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?>
			</li>
		</ul>
      </div>
<!-- </center> -->
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		<div class="container">
			...
			<h2 class="form-signin-heading">
				<span>
					<?php __('Add Secure Control User'); ?>
				</span>
			</h2>
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
				...
				echo $this->Form->input('view_get_payrolls_id',array(
													'type' => 'select',
													'multiple' => true,
													'placeholder'=>'view_get_payrolls_id',
													'class'=>'input'
													)
								);
