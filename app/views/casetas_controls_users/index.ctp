...
<!-- 													<th><?php echo $this->Paginator->sort('casetas_parents_id');?></th> -->
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($casetasControlsUser['User']['name'].' '. $casetasControlsUser['User']['last_name'], array('controller' => 'users', 'action' => 'view', $casetasControlsUser['User']['id'])); ?>
		</td>
		<td>
		...
		<td>
			<?php
				echo $this->Html->link($bsu[$casetasControlsUser['CasetasUnits']['id']], array('controller' => 'BusinessUnits', 'action' => 'view', $casetasControlsUser['CasetasUnits']['id'])); 
			?>
