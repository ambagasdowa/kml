...
?>
      ...
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectionsGlobalCorp.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectionsGlobalCorp.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Projections Global Corps', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Projections Global Corp'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('ProjectionsGlobalCorp',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="projectionsGlobalCorps form">
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
		...
		echo $this->Form->input('projections_global_companies_name',array('placeholder'=>'projections_global_companies_name','class'=>'input'));
		echo $this->Form->input('projections_global_companies_desc',array('placeholder'=>'projections_global_companies_desc','class'=>'input'));
