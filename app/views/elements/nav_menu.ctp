...
<!-- 										automagic hir -->
                    ...
                    <?php if (isset($_SESSION['Auth']['User'])) {?>
										<?php 	if (checkUser($_SESSION['Auth']['User']['group_id'],'Contraloria')  OR checkUser($_SESSION['Auth']['User']['group_id'],'Contraloria') ) {?>

                      <li class="dropdown-submenu">
  											<a tabindex="-1" href="#"><i class="fa fa-cog"></i>&nbsp;<span>Gerencial</span></a>
  												<ul class="dropdown-menu">
  													<li><a tabindex="-1" href="<?php e($this->webroot.'RentabilidadViewMainLiquidations');?>"><i class="fa fa-cog"></i>&nbsp;<span>Rentabilidad</span></a></li>
  													<!-- <li><a tabindex="-1" href="<?php e($this->webroot.'Tralixes/add');?>"><i class="fa fa-cog"></i>&nbsp;<span>edition</span></a></li> -->
  												</ul>
  										</li>
                    ...
                    <li class="dropdown-submenu">
                      <a tabindex="-1" href="#"><i class="fa fa-line-chart"></i>&nbsp;<span>Rendimiento/Disponibilidad</span></a>
                        <ul class="dropdown-menu">
                          ...
                          <li class="dropdown-submenu pull-left">
															 <a href="<?php e($this->webroot.'DisponibilidadViewRptUnidadesGstIndicators/');?>">
																		<i class="fa fa-pencil-square-o"></i>&nbsp;<span>Disponibilidad</span>
															 </a>
                          </li>
