...
// NOTE Bootstrap
      ...
      e($this->Html->script($theme.'highCharts/plugin/export-csv',false));
			...
			// NOTE Module Disponibilidad
//			e($this->Html->script($theme.'configurations/diponibilidad_conf',false));
			e($this->Html->css($default.'modules/disponibilidad/graphs', 'stylesheet', array('inline'=>false)));
