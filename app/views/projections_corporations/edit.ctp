...
?>
      ...
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectionsCorporation.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectionsCorporation.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Projections Corporations', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Projections Corporation'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('ProjectionsCorporation',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="projectionsCorporations form">
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
		...
		echo $this->Form->input('id_projections_global_corps',array('placeholder'=>'id_projections_global_corps','class'=>'input'));
		echo $this->Form->input('projections_companies_name',array('placeholder'=>'projections_companies_name','class'=>'input'));
		echo $this->Form->input('projections_companies_desc',array('placeholder'=>'projections_companies_desc','class'=>'input'));
		echo $this->Form->input('user_id',array('placeholder'=>'user_id','class'=>'input'));
		echo $this->Form->input('projections_standings_id',array('placeholder'=>'projections_standings_id','class'=>'input'));
		echo $this->Form->input('projections_parents_id',array('placeholder'=>'projections_parents_id','class'=>'input'));
