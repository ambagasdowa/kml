...
<!-- <center> -->
      ...
      <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
				...
				<li>
					<?php echo $this->Html->link(__('List Users', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>
				</li>
				<li>
...
// 						echo $this->Form->input('languaje',array('placeholder'=>'languaje','class'=>'input'));
						echo $this->Form->input('languaje',
								array(
										'type'=>'select',
										'options'=>array('es'=>'spanish','en'=>'english'),
										'class'=>'form-control',
										'label'=>false,
										'placeholder'=>'Language'
										)
						);
						echo $this->Form->input('number_id',array('type'=>'text','placeholder'=>'number_id','class'=>'input'));
...
// 						echo $this->Form->input('super_user',array('placeholder'=>'super_user','class'=>'input'));
						echo $this->Form->input('super_user',
								array(
										'type'=>'select',
										'options'=>array('1'=>'Activado','0'=>'Desactivado'),
										'class'=>'form-control',
										'label'=>false,
