...
?>
      ...
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectionsViewClosedPeriod.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectionsViewClosedPeriod.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Projections View Closed Periods', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Projections View Closed Period'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('ProjectionsViewClosedPeriod',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="projectionsViewClosedPeriods form">
