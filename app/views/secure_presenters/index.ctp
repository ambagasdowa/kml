...
?>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $securePresenter['SecurePresenter']['id']),array('data-edit'=>'linkSecurePresenters_'.$securePresenter['SecurePresenter']['id'])); ?>
		</td>
		<td class="actions">
...
<?php endforeach; ?>
	...
	?>				</ul>
					<span class="pull-right">
						<?php echo $this->Html->link(__('New Secure Presenter', true), array('action' => 'add'),array('class'=>'btn btn-success','id'=>'newSecurePresenters')); ?>
					</span>
          </div>
