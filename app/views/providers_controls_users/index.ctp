    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Providers Controls User', true), array('action' => 'add')); ?>			</li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Providers Controls Users');?></h1>
          <div class="table-responsive">
			<span class="filter-container">
				...
				<?php
				$i = 0;
				foreach ($providersControlsUsers as $providersControlsUser):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
				?>
	<tr<?php echo $class;?>>
		<td><?php echo $providersControlsUser['ProvidersControlsUser']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $providersControlsUser['ProvidersControlsUser']['created']; ?>&nbsp;</td>
		<td><?php echo $providersControlsUser['ProvidersControlsUser']['modified']; ?>&nbsp;</td>
		<td><?php echo $providersControlsUser['ProvidersControlsUser']['_status']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $providersControlsUser['ProvidersControlsUser']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $providersControlsUser['ProvidersControlsUser']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $providersControlsUser['ProvidersControlsUser']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $providersControlsUser['ProvidersControlsUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
