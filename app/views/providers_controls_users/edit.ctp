...
?>
      ...
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProvidersControlsUser.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProvidersControlsUser.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Providers Controls Users', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Providers Controls User'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('ProvidersControlsUser',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="providersControlsUsers form">
