...
<!-- <center> -->
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FieldName.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FieldName.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Field Names', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
						<li><?php echo $this->Html->link(__('List Catalog Names', true), array('controller' => 'catalog_names', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?> </li>
		<li><?php echo $this->Html->link(__('New Catalog Names', true), array('controller' => 'catalog_names', 'action' => 'add'),array('class'=>'btn btn-default list-group-item')); ?> </li>
		<li><?php echo $this->Html->link(__('List Catalog Fields', true), array('controller' => 'catalog_fields', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?> </li>
		<li><?php echo $this->Html->link(__('New Catalog Fields', true), array('controller' => 'catalog_fields', 'action' => 'add'),array('class'=>'btn btn-default list-group-item')); ?> </li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Field Name'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('FieldName',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="fieldNames form">
...
// 		echo $this->Form->input('catalog_datas_id',array('placeholder'=>'catalog_datas_id','class'=>'input'));
		echo $this->Form->input('field_names',array('placeholder'=>'field_names','class'=>'input'));
		echo $this->Form->input('field_description',array('placeholder'=>'field_description','class'=>'placeholder','label'=>false,'rows'=>'5','cols'=>'80'));
