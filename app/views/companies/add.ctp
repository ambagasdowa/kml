...
<!-- 				 -->
		...
		echo $this->Form->input('name',array('class'=>null,'placeholder'=>'Name of the company'));
		echo $this->Form->input('description',array('type'=>'textarea','class'=>'placeholder','label'=>false,'placeholder'=>'Descripcion del Documento','rows'=>'5','cols'=>'80'));
...
// 																	'max' => '2036-12-31',
				...
				echo $this->Form->input('nom_id',array('type'=>'text','placeholder'=>'Nom2001_Id'));
