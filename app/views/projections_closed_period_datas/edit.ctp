...
?>
    ...
    <div class="col-md-offset-1 col-sm-11 col-md-11">
    		...
    		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjectionsClosedPeriodData.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjectionsClosedPeriodData.id'))); ?></li>
        <li><?php echo $this->Html->link(__('List Projections Closed Period Datas', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?></li>
        <li><?php echo $this->Html->link(__('List Users', true), array('controller' => 'users', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?> </li>
    		...
    		<li><?php echo $this->Html->link(__('List Projections Closed Period Controls', true), array('controller' => 'projections_closed_period_controls', 'action' => 'index'),array('class'=>'btn btn-default list-group-item')); ?> </li>
    		<li><?php echo $this->Html->link(__('New Projections Closed Period Controls', true), array('controller' => 'projections_closed_period_controls', 'action' => 'add'),array('class'=>'btn btn-default list-group-item')); ?> </li>
			</ul>
    </div>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Projections Closed Period Data'); ?>			</span>
		</h2>

          <?php echo $this->Form->create('ProjectionsClosedPeriodData',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="projectionsClosedPeriodDatas form">
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
                		...
                		echo $this->Form->input('projections_closed_period_controls_id',array('placeholder'=>'projections_closed_period_controls_id','class'=>'input'));
