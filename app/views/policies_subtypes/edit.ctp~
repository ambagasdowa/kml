...
<center>
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
				...
				<li>
					<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PoliciesSubtype.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PoliciesSubtype.id'))); ?>						</li>
				<li>
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
		...
		echo $this->Form->input('policies_type_id',array('placeholder'=>'policies_type_id','class'=>'input'));
// 		echo $this->Form->input('name',array('placeholder'=>'name','class'=>'input','label'=>false));
		echo $this->Form->input('policies_subtypes_definitions_id',
									array(
											'type'=>'select',
											'options'=>$policies_subtypes_definitions,
											'class'=>'form-control',
											'label'=>false,
