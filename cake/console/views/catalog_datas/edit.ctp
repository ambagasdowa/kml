...
<center>
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CatalogData.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CatalogData.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Catalog Datas', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
		...
		echo $this->Form->input('catalog_data_description',array('placeholder'=>'catalog_data_description','class'=>'input'));
