<?php 
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Providers View Search Edition', true), array('action' => 'add')); ?>			</li>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $providersViewSearchEdition['ProvidersViewSearchEdition']['ZMontoPago']; ?>&nbsp;</td>
		...
		<td><?php echo $providersViewSearchEdition['ProvidersViewSearchEdition']['Status']; ?>&nbsp;</td>
		<td class="actions">
