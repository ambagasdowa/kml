    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Casetas Pending', true), array('action' => 'add')); ?>			</li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Casetas Pendings');?></h1>
          <div class="table-responsive">
			<span class="filter-container">
				...
				<?php
				$i = 0;
				foreach ($casetasPendings as $casetasPending):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
				?>
	<tr<?php echo $class;?>>
		<td><?php echo $casetasPending['CasetasPending']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasPending['CasetasPending']['_status']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $casetasPending['CasetasPending']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $casetasPending['CasetasPending']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $casetasPending['CasetasPending']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $casetasPending['CasetasPending']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
