...
<center>
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('SecureCalendar.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('SecureCalendar.id'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Secure Calendars', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Secure Calendar'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('SecureCalendar',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="secureCalendars form">
...
<!-- 					<table class="table table-bordered table-hover table-striped responstable"> -->
		...
		echo $this->Form->input('title',array('placeholder'=>'title','class'=>'input'));
		echo $this->Form->input('allday',array('placeholder'=>'allday','class'=>'input'));
		echo $this->Form->input('editable',array('placeholder'=>'editable','class'=>'input'));
		echo $this->Form->input('start',array('placeholder'=>'start','class'=>'input'));
		echo $this->Form->input('end',array('placeholder'=>'end','class'=>'input'));
		echo $this->Form->input('url',array('placeholder'=>'url','class'=>'input'));
		echo $this->Form->input('constraint',array('placeholder'=>'constraint','class'=>'input'));
		echo $this->Form->input('color',array('placeholder'=>'color','class'=>'input'));
		echo $this->Form->input('rendering',array('placeholder'=>'rendering','class'=>'input'));
		echo $this->Form->input('overlap',array('placeholder'=>'overlap','class'=>'input'));
