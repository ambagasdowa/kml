<?php 
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $reporterViewsMainSubreport['ReporterViewsMainSubreport']['Description']; ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $reporterViewsMainSubreport['ReporterViewsMainSubreport']['ID'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $reporterViewsMainSubreport['ReporterViewsMainSubreport']['ID'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $reporterViewsMainSubreport['ReporterViewsMainSubreport']['ID']), null, sprintf(__('Are you sure you want to delete # %s?', true), $reporterViewsMainSubreport['ReporterViewsMainSubreport']['ID'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
