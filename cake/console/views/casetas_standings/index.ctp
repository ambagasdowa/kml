    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Casetas Standing', true), array('action' => 'add')); ?>			</li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Casetas Standings');?></h1>
          <div class="table-responsive">
			<span class="filter-container">
				...
				<?php
				$i = 0;
				foreach ($casetasStandings as $casetasStanding):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
				?>
	<tr<?php echo $class;?>>
		<td><?php echo $casetasStanding['CasetasStanding']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasStanding['CasetasStanding']['casetas_standings_name']; ?>&nbsp;</td>
		<td><?php echo $casetasStanding['CasetasStanding']['created']; ?>&nbsp;</td>
		<td><?php echo $casetasStanding['CasetasStanding']['modified']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($casetasStanding['User']['name'], array('controller' => 'users', 'action' => 'view', $casetasStanding['User']['id'])); ?>
		</td>
		<td><?php echo $casetasStanding['CasetasStanding']['_status']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $casetasStanding['CasetasStanding']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $casetasStanding['CasetasStanding']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $casetasStanding['CasetasStanding']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $casetasStanding['CasetasStanding']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
