    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-sm-11 col-md-11">
          <ul class="list-group list-inline">
			<li class="list-group-item">
				<?php echo $this->Html->link(__('New Casetas Controls Event', true), array('action' => 'add')); ?>			</li>
        ...
        <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-1 main">
          <h1 class="page-header"><?php __('Casetas Controls Events');?></h1>
			...
			<span class="filter-container">
				...
				<thead>
					<tr>
													...
													<th><?php echo $this->Paginator->sort('casetas_events_from');?></th>
													<th><?php echo $this->Paginator->sort('casetas_events_to');?></th>
				...
				<?php
				$i = 0;
				foreach ($casetasControlsEvents as $casetasControlsEvent):
					$class = null;
					if ($i++ % 2 == 0) {
						$class = ' class="altrow"';
					}
				?>
	<tr<?php echo $class;?>>
		<td><?php echo $casetasControlsEvent['CasetasControlsEvent']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasControlsEvent['CasetasControlsEvent']['casetas_events_from']; ?>&nbsp;</td>
		<td><?php echo $casetasControlsEvent['CasetasControlsEvent']['casetas_events_to']; ?>&nbsp;</td>
		<td><?php echo $casetasControlsEvent['CasetasControlsEvent']['created']; ?>&nbsp;</td>
		<td><?php echo $casetasControlsEvent['CasetasControlsEvent']['modified']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $casetasControlsEvent['CasetasControlsEvent']['_status']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $casetasControlsEvent['CasetasControlsEvent']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $casetasControlsEvent['CasetasControlsEvent']['id'])); ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $casetasControlsEvent['CasetasControlsEvent']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $casetasControlsEvent['CasetasControlsEvent']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
				</table>
