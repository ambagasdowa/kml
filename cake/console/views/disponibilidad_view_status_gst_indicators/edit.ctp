...
?>
      ...
      <?php 	echo $this->Session->flash();?>        <div class="col-md-offset-1 col-sm-11 col-md-11">
			<ul class="list-group list-inline">
										...
										<li>
							<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('DisponibilidadViewStatusGstIndicator.id_status')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('DisponibilidadViewStatusGstIndicator.id_status'))); ?>						</li>
										<li>
							<?php echo $this->Html->link(__('List Disponibilidad View Status Gst Indicators', true), array('action' => 'index'),array('class'=>'btn btn-default list-group-item'));?>						</li>
...
<!--         <div class="col-sm-9 col-sm-offset-2 col-md-6 col-md-offset-3 main"> -->
		...
		<i class="fa fa-file-o fa-2x"></i>
		  <h2 class="form-signin-heading">
			<span>
					 <?php __('Edit Disponibilidad View Status Gst Indicator'); ?>			</span>
		</h2>
		
          <?php echo $this->Form->create('DisponibilidadViewStatusGstIndicator',array('enctype' => 'multipart/form-data','class'=>'form'));?>
			<div class="disponibilidadViewStatusGstIndicators form">
